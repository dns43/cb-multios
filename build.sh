...
CC=${CC:-/home/dennis/projects/research/gradtest/llvm-7.0.0.build/`uname -m`/llvm-7.0/bin/bin/clang} #${CC:-clang}
CXX=${CXX:-/home/dennis/projects/research/gradtest/llvm-7.0.0.build/`uname -m`/llvm-7.0/bin/bin/clang++} #${CXX:-clang++}
